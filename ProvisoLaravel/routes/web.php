...
Route::get('print-recommendations', [GraphController::class, 'print_recommendations'])->name('print.recommendations')->middleware('web');
Route::get('print-minor-recommendations', [GraphController::class, 'print_minor_recommendations'])->name('print.minor.recommendations')->middleware('web');
